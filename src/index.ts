...
export { usePromiseWithInterval } from "./usePromiseWithInterval";
...
export { PromiseMatcher, UsePromise, PromiseResultShape, PromiseLoader, UsePromiseWithInterval } from "./types";
